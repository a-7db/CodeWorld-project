	...
	<div class="row">
		<nav class="col-12">
			<ul class="nav row" id="myTab" role="tablist">
				...
				<li class="nav-item col-xl-3 col-sm-6 mb-xl-0 mb-4" role="presentation">
					<a role="button" class="nav-item" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
						<div class="">
							<div class="card">
								<div class="card-body p-3">
									<div class="row">
						...
						<div class="card-body px-0 pt-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
									...
									<tbody>
										<?php foreach ($data['myUsers'] as $myusers) : ?>
											<tr>
												<td>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header pb-0 px-3">
							<h6 class="mb-0">Your Trainees</h6>
						</div>
						<div class="card-body pt-4 p-3">
							<ul class="list-group">
								<?php foreach ($data['crs'] as $crs) : ?>
									<a href="<?php echo URLROOT . '/Instructors/show_my_trainees/' . $crs->crs_ID . '/' . $crs->slug ?>">
										<li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
											<img class="w-25" src="<?php echo URLROOT . './public/images/courses/' . $crs->image ?>" alt="">
											<div class="d-flex flex-column">
												<h6 class="mb-3 text-md text-wrap" style="width: 50%; margin-left: 5%;"><?php echo $crs->title ?></h6>
												<div class="text-sm" style="width: 50%; margin-left: 5%;"><?php echo $crs->count ?> Trainees</div>
											</div>
										</li>
									</a>
								<?php endforeach; ?>
